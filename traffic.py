...
def load_data(data_dir):
    ...
    for i in range(len(os.listdir(data_dir))):
        print(f"Loading images in folder {i}...")
        ...
        for f in files: 
            ...
            # Using OpenCV-Python, convert image into multidimensional array
...
def get_model():
    ...
    model = tf.keras.models.Sequential([
        ...
        # Input layer: Convolutional layer. Learn 32 filters using a 3x3 kernel
